...
<img src="https://github.com/raulneto90/gostack-desafio06/blob/master/images/test.png" alt="Testes do desafio" />
...
```bash
$ git clone https://github.com/raulneto90/gostack-desafio06
$ cd gostack-desafio06
